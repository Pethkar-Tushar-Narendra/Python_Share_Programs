...
worksheet_1_min = sh.worksheet('INTRADAY_DATA')

while 1:
    end = datetotimestamp(datetime.today())
    if worksheet_1_min.acell('K18').value == 'SHARE':
        year= worksheet_1_min.acell('K9').value
        month= worksheet_1_min.acell('K12').value
        day= worksheet_1_min.acell('K15').value
        company= worksheet_1_min.acell('K3').value
        time1= worksheet_1_min.acell('K6').value
        ...
        month= worksheet_1_min.acell('K12').value
        day= worksheet_1_min.acell('K15').value
        number= worksheet_1_min.acell('K25').value
        time1= worksheet_1_min.acell('K6').value
        start_1_min = datetotimestamp(datetime(int(year), int(month), int(day)))
